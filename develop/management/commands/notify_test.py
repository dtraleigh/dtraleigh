...
class Command(BaseCommand):
    def handle(self, *args, **options):
        ...
        test_items_update = [
            ...
            TextChangeCase.objects.all().last(),
            AdministrativeAlternate.objects.all().last(),
            SiteReviewCase.objects.all().last(),
            NeighborhoodMeeting.objects.all().last(),
            DesignAlternateCase.objects.all().last()
        ]
